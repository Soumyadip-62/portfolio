...
const Education = () => {
  return (
    <div
      ...
      data-aos="fade-up"
    >
      <div className="flex justify-center  text-2xl font-sans font-bold">
        <header>My Educational Background</header>
      </div>

      <div class="grid grid-cols-1 text-center mt-12 md:grid-cols-3 md:text-left ">
        <div class=" p-4 m-4 hover:bg-secondary hover:text-white hover:shadow-xl hover:shadow-black duration-300">
